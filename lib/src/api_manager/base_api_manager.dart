...
abstract class BaseAPIManager {
  BaseAPIManager(this._baseURL, [this._authorization]);
  ...
  Future<http.Response> _response(
    ...
    switch (type) {
      case _ResponseType._get:
        return await http.get(_uri(_formattedParams(url, params)), headers: authHeaders);
      case _ResponseType._post:
        return await http.post(_uri(url), headers: authHeaders, body: body, encoding: encoding);
      case _ResponseType._put:
        return await http.put(_uri(url), headers: authHeaders, body: body, encoding: encoding);
      case _ResponseType._patch:
        return await http.patch(_uri(url), headers: authHeaders, body: body, encoding: encoding);
      case _ResponseType._delete:
        return await http.delete(_uri(url), headers: authHeaders, body: body, encoding: encoding);
    }
  }
