...
class BaseRepositoryGenerator {
  ...
  String template(String packageName) {
    ...
    buffer.write("import 'package:flutter_pack/flutter_pack.dart' show BaseDataRepository;\n");
    buffer.write("import 'package:flutter_pack/src/model_manager.dart';\n");
    buffer.write("import 'package:flutter_pack/src/model_manager.dart';\n");
    buffer.write("import 'package:mealgro/services/database_manager.dart';\n");
...
class DatabaseGenerator {
  ...
  String template(String packageName) {
    StringBuffer buffer = StringBuffer();
    buffer.write("import 'package:flutter_pack/flutter_pack.dart' show BaseDatabaseManager;\n");
    buffer.write("import 'package:flutter_pack/src/model_manager.dart;\n");
