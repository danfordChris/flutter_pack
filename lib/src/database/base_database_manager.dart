...
import 'package:flutter_pack/src/database/database_migrator.dart';
...
abstract class BaseDatabaseManager extends BaseDatabaseMigrator {
  BaseDatabaseManager(this._dbName, this._dbVersion, this._models)
      : _encrypted = false,
        super(_models);
  ...
  Future<sqflite.Database> get _instanceDatabase async {
    ...
    if (_encrypted) {
      // return await _encryptedDatabase;
    }
